...
plot3(surface_ax,startLocation(1),startLocation(2),startLocation(3),'s',...
    'MarkerSize',6,'LineWidth',3,'Color',[1 0 1],...
    'MarkerFaceColor',[1 0 1],'DisplayName','StartLocation');

plot3(surface_ax,endLocation(1),endLocation(2),endLocation(3),'O',...
    'MarkerSize',6,'LineWidth',3,'Color',[ 0 1 0],...
    'MarkerFaceColor',[0 1 0],'DisplayName','GoalLocation');

plotTerrainSurfaceWithObs(surface_ax,xg,yg,z_heights,...
    terrain_points_obs,...
    sharp_rocks_pts,...
    round_rocks_pts,...
    ditches_pts,...
